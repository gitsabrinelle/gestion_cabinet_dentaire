...
if (isset($_GET["id_bl"])&&isset($_GET["_client"])&&strlen($_GET["_client"]))
{ 
$jj = $_GET["_client"];
$gett=$_GET["id_bl"]; 
...
$ff= "Location:historique_bl.php?_client=".$jj;
	header($ff);
...
if (isset($_GET["id_bl"])&& !isset($_GET["_client"]) && strlen($_GET["_client"])==0)
{ 
//$jj = $_GET["ref_client"];
$gett=$_GET["id_bl"]; 
$sql = mysqli_query($link,"DELETE FROM detail_bl WHERE id_bl = '".$gett."'")or die (mysqli_error($link));
