...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
    ...
    <div class="main-content">
        ...
        <form method="GET" action="recettes.php">
            ...
            <table width="45%" border="2" align="center" class="table table-bordered table-striped datatable">
                <tr height="50">
                    <td>
                        <?php
...
ORDER BY  `bl`.`date` DESC LIMIT 0,1");
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input style=" width:100px ; height:50px;" type="submit" value = "Envoyer" class="btn btn-green"/>
                    </td>
                </tr>
            </table >
        </form>
