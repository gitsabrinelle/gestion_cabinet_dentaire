...
$gett=$_GET["id_fachat"]; 
 $sql = mysqli_query($link,"DELETE FROM detail_fachat WHERE id_fachat = '".$gett."'")or die (mysqli_error($link));

 $sql = mysqli_query($link,"DELETE FROM facture_achat WHERE id_fachat = '".$gett."'")or die (mysqli_error($link));
$ff= "Location:tous_factures_achats.php";
	header($ff);
