...
<th>
Quantite vendue (Magasin)
</th>
<th>
Quantite Reste (Magasin)
</th>
<th>
Quantite vendue (Comptable)
</th>

<th>
Quantite Reste (Comptable)
</th>

<th>
Possibilite de Facturation
</th>
...
echo(" ".$quantite_total ); ?>
            ...
            <td>	<?php  echo("".$quantite_total-$quant_vendu ); ?></td>
            
            <td height="30" align="center">
				<?php echo(" ".$quant_comptab); ?>
			</td>
            <td><?php  echo("".$quantite_total-$quant_comptab ); ?></td>
          <td><?php  if($quant_comptab-$quant_vendu <0) echo("OK" ); ?></td>  <td height="30" align="center">
