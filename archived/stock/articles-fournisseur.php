...
$re="select * from articles where ref_fournisseur= '".$ref_fournisseur."' ";
...
<a style="color:#FFFF66" href="articles-fournisseur.php?ref_fournisseur=<?php if (isset($_GET["ref_fournisseur"])) echo $ref_fournisseur?>&des=
<?php
  if (isset($_GET['des']))
	{
		if ($_GET['des']==1)
