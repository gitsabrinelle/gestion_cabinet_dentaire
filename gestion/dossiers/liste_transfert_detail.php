...
if(isset($_POST['submit']) ) {
    ...
    if (isset($_POST['date']))
        $date = $_POST['date'];
            ...
            //$__transferts = mysqli_insert_id($link);
            if ($request) {
...
<meta http-equiv="refresh"
      content="1;URL=index.php?p=gestion/dossiers/liste_transfert_atelier.php/<?php echo $_dossiers ?>">
